...
const ProfileIcon = () =>
	<svg className={styles.icons} width="30" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" >


		<g id="Page-1" stroke="none" stroke-width="1" fill="currentColor" fill-rule="currentColor">
